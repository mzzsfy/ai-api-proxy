...
# 默认形态真正拉取的依赖均公开可达
RUN go mod edit -dropreplace=github.com/mzzsfy/warp-pool -dropreplace=github.com/mzzsfy/ai-api-proxy-plugin-proxy/mihomoprovider \
                -droprequire=github.com/mzzsfy/ai-api-proxy-plugin-proxy/mihomoprovider \
 && go mod download
COPY . .
